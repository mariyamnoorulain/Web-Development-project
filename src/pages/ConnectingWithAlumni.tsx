      ...
      <section className="relative bg-green-800 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Connecting with Alumni</h1>
            <p className="text-xl">Access exclusive tools and resources designed for career advancement and professional growth through our alumni network.</p>
          </div>
        </div>
      </section>
