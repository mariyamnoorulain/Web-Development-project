        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Enjoy these exclusive advantages as a registered member of the Namal Alumni Network
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Connect with over 5,000 alumni across 120+ countries through our online directory, 
                events, and regional chapters.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold text-green-800 mb-3">Career Development</h3>
              <p className="text-gray-600">
                Access job postings, career counseling, professional development workshops, 
                and our exclusive mentorship program.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Participate in alumni-only events, reunions, webinars, and networking sessions 
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold text-green-800 mb-3">Continued Learning</h3>
              <p className="text-gray-600">
                Enjoy discounted access to Namal's continuing education programs, library resources, 
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              <div className="bg-green-100 p-4 rounded-full w-16 h-16 flex items-center justify-center mb-6">
                <Mail className="h-8 w-8 text-green-800" />
              </div>
              <h3 className="text-xl font-bold text-green-800 mb-3">Stay Informed</h3>
              <p className="text-gray-600">
                Receive our quarterly alumni newsletter, university updates, and invitations 
                to special campus events.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Opportunities to mentor students, volunteer for university initiatives, 
                and contribute to scholarship funds.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <button className="w-full px-4 py-2 bg-green-800 hover:bg-green-700 text-white font-bold rounded-md transition-colors">
                  Register Now
                </button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transform scale-105 border-2 border-yellow-500">
              ...
              <div className="p-6">
                ...
                <button className="w-full px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-green-900 font-bold rounded-md transition-colors">
                  Join Now
                </button>
              </div>
            </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <form className="bg-gray-50 p-8 rounded-lg shadow-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  <label htmlFor="degree" className="block text-sm font-medium text-gray-700 mb-1">Degree Program</label>
                  <select
                    id="degree"
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  >
                    ...
                    <option value="msee">MS Electrical Engineering</option>
                  </select>
                </div>
              </div>
      ...
      <section className="py-16 bg-green-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Hear from alumni who have benefited from being part of our network
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              <div className="flex items-center mb-4">
                ...
                />
                <div>
                  <h4 className="font-bold text-green-800">Hassan Ali</h4>
                  <p className="text-gray-500 text-sm">Class of 2016</p>
                </div>
              </div>
              <p className="text-gray-600 italic">
                "The Namal Alumni Network has been instrumental in my career growth. Through the mentorship program, 
                I connected with industry leaders who guided me to my current position."
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              <div className="flex items-center mb-4">
                ...
                />
                <div>
                  <h4 className="font-bold text-green-800">Amina Siddiqui</h4>
                  <p className="text-gray-500 text-sm">Class of 2014</p>
                </div>
              </div>
              <p className="text-gray-600 italic">
                "Being part of this network has allowed me to give back to my alma mater while staying connected 
                with fellow alumni. The events and reunions are always a highlight of my year!"
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              <div className="flex items-center mb-4">
                ...
                />
                <div>
                  <h4 className="font-bold text-green-800">Omar Khan</h4>
                  <p className="text-gray-500 text-sm">Class of 2018</p>
                </div>
              </div>
              <p className="text-gray-600 italic">
                "The job portal exclusively for Namal alumni helped me land my dream job. The network's resources 
                and support have been invaluable for my professional development."
              </p>
            </div>
          </div>
        </div>
